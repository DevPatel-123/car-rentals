...
const Testimonial = () => {
      ...
      <div className="flex items-center gap-1">
        {Array.from({ length: 5 }, (_, index) => (
          <svg
            ...
            height="15"
            viewBox="0 0 16 15"
            fill={index < rating ? "#DC2626" : "#E5E7EB"}
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-gray-50 to-red-50">
      <div className="max-w-7xl mx-auto">
        <Title
          title="Trusted by Thousands"
          subTitle="Real experiences from our happy customers across Maharashtra."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="group p-8 rounded-2xl bg-white shadow-md border-2 border-red-100 hover:border-red-300 hover:shadow-2xl transition-all duration-500 cursor-pointer hover:-translate-y-2"
            >
              <div className="mb-6">
              ...
              <div className="relative">
                <svg
                  className="absolute -top-2 -left-2 w-6 h-6 text-red-100"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
